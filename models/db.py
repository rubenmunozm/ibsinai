...
db.define_table('mensajes',
    Field('nombre','string', notnull=True, length=50),
    Field('correo','string', notnull=True, length=50), 
    Field('telefono','string', notnull=False, length=22),
    Field('mensaje','text', notnull=True),
    auth.signature,
    )

db.define_table('versos_biblicos',
    Field('numero','integer', notnull=True),
    Field('verso','string'),
    Field('cita','string',length=25),
    )

db.define_table('bible_verses',
    Field('numero','integer', notnull=True),
    Field('verso','string'),
    Field('cita','string',length=25),
    )
